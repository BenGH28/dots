...
layout_theme = {
    "border_width": 4,
    "margin": 6,
    "border_focus": dracula["orange"],
    "border_normal": dracula["purple"],
}
...
widget_padding = 10
myWidgets = [
    widget.GroupBox(foreground=dracula["orange"]),
    widget.WindowName(foreground=dracula["purple"]),
    widget.CurrentLayout(foreground=dracula["yellow"]),
...
#### My Screens ####
screens = [
    Screen(top=bar.Bar(myWidgets, 24, background=dracula["background"]),),
]
